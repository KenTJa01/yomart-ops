                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        ...
                        <ul id="dropdown-kelola-lokasi" class="hidden py-2 space-y-2 text-sm">
                            ...
                            <li>
                                <a href="/kelola_lokasi/data_ban" class="flex items-center w-full p-3 text-white transition duration-75 rounded-lg pl-8 group hover:bg-batman-800 {{ Request::routeIs('/kelola_lokasi/vendor') ? 'bg-batman-900' : '' }}">
                                    <img src="{{ asset('svg/list.svg') }}" class="w-[22px] h-[22px] mr-2" />
                                    Data BAN
                                </a>
                            </li>
