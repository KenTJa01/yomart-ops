    ...
    <div class="rounded-lg">
        ...
        <div class="bg-white border border-batman-50 rounded-lg p-4 shadow-sm flex flex-col">
            <div class="flex items-center">
                <span class="text-xl font-semibold text-batman-900">Data Objek</span>
            </div>
            ...
            <div class="relative overflow-x-auto sm:rounded-lg">
                <table class="tableData w-full text-sm text-left rtl:text-right text-batman-900" id="tableData">
                    <thead class="text-sm text-white uppercase bg-batman-900">
                        <tr>
                            <th rowspan="2" scope="col" class="top_left_tableData px-6 py-5 !pl-[25px] border-t-0 border-l-0" style="z-index: 9999;">No.</th>
                            <th rowspan="2" scope="col" class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">No. Pengajuan</th>
                            <th rowspan="2" scope="col" class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">No. Objek</th>
                            <th rowspan="2" scope="col" class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Nama Toko</th>
                            <th rowspan="2" scope="col" class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Nama di Sertifikat</th>
                            <th rowspan="2" scope="col" class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Status</th>

                            <th colspan="15" scope="col" class="px-6 py-5 !pl-[25px] border-t-0">Alamat & Spesifikasi</th>
                            <th colspan="2" scope="col" class="px-6 py-5 !pl-[25px] border-t-0">Data Master Pemilik</th>
                            <th colspan="2" scope="col" class="px-6 py-5 !pl-[25px] border-t-0">Perjanjian Sewa / SHBG / AJB</th>
                            <th colspan="4" scope="col" class="px-6 py-5 !pl-[25px] border-t-0">Informasi PBB</th>
                            <th colspan="3" scope="col" class="px-6 py-5 !pl-[25px] border-t-0">Masa Berlaku Sewa</th>

                            <th rowspan="2" scope="col" class="top_right_tableData border-t-0 border-r-0"
                                style="width: 60px !important;">
                                <img src="{{ asset('svg/action.svg') }}" class="w-5 h-5 m-auto">
                            </th>
                        </tr>
                        <tr>
                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Alamat Lengkap</th>
                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Kecamatan</th>
                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Kelurahan</th>
                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Kota/Kabupaten</th>
                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Wilayah</th>
                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Regional</th>
                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Cluster</th>
                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Lokasi</th>
                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Luas Tanah (m2)</th>
                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Luas Bangunan (m2)</th>
                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Hak Atas Tanah</th>
                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">PBG</th>
                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Keterangan PBG</th>
                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">SLH</th>
                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">NIB</th>

                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Nama Pemilik</th>
                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Kontak Pemilik</th>

                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Tanggal Perjanjian</th>
                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Keterangan</th>

                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">NOP</th>
                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Atas Nama</th>
                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Tanggungan</th>
                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Masa Tanggungan</th>

                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Tanggal Mulai</th>
                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Tanggal Berakhir</th>
                            <th class="px-6 py-5 !pl-[25px] border-t-0" style="width: 200px">Lama Sewa (Tahun)</th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
