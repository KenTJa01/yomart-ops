    ...
    <div class="rounded-lg">
        ...
        <div class="bg-white border border-batman-50 rounded-lg p-4 shadow-sm flex flex-col">
            <div class="flex items-center">
                ...
                <span class="text-lg ml-2 font-semibold text-batman-900">Master Cook Food</span>
            </div>
                ...
                <table class="tableData w-full text-sm text-left rtl:text-right text-batman-900" id="tableData">
                    <thead class="text-sm text-white uppercase bg-batman-900">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-5 !pl-[25px] border-t-0">Kode Cook Food</th>
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <div class="flex flex-col">
                        <table>
                            <tr>
                                <td style="width: 20%">
                                    <label for="kode_cook_food" class="block text-sm font-medium text-batman-900">Kode Cook Food</label>
                                </td>
                                <td style="width: 80%">
                                    <input type="text" id="kode_cook_food" name="kode_cook_food" style="margin-bottom: 5px !important"
                                    ...
                                    placeholder="Masukkan kode cook food" required>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 20%">
            ...
            <div class="relative bg-white rounded-lg shadow-sm ">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <div class="flex flex-col">
                        ...
                        <input type="hidden" id="cook_food_id_edit">
                        <table>
                            <tr>
                                <td style="width: 20%">
                                    <label for="kode_cook_food_edit" class="block text-sm font-medium text-batman-900">Kode Cook Food</label>
                                </td>
                                <td style="width: 80%">
                                    <input type="text" id="kode_cook_food_edit" name="kode_cook_food_edit" style="margin-bottom: 5px !important"
                                    ...
                                    placeholder="Masukkan kode cook food" disabled>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 20%">
    ...
    <script>
        ...
        function dataTable() {
            ...
            var tableData = $("#tableData").DataTable({
                ...
                ajax: {
                    type: 'GET',
                    url: `{{ route('get-cook-food-list-datatable') }}`,
                    data: {},
                },
                columns: [{
                        data: 'DT_RowIndex',
        ...
        $(document).on('click', '#button_submit_modal', function(event) {
            ...
            var kode_cook_food = $("#kode_cook_food").val();
        ...
        $(document).on('click', '#button_edit_modal', function () {
            ...
            $.ajax({
                type: 'GET',
                url: "{{ url('/get-old-data-of-cook-food') }}",
                dataType: 'json',
                data: {
                    cook_food_id: data_id,
                },
                success: function(response) {

                    $("#cook_food_id_edit").val(response.id);
                    $("#kode_cook_food_edit").val(response.kode_cook_food);
                ...
                error: function(error) {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: "Error",
                        text: error.responseJSON.message ?? 'Failed get list of cook food',
                        showConfirmButton: true,
                        confirmButtonColor: "#c1141b",
                        customClass: {
                            confirmButton: 'custom-confirm-button-swal'
        ...
        $(document).on('click', '#button_submit_modal_edit', function() {
            ...
            var id = $("#cook_food_id_edit").val();
            var kode_cook_food = $("#kode_cook_food_edit").val();
